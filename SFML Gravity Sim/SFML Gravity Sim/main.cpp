...
//  SFML Gravity Sim
//
//  Created by Juzar Batterywala on 28/08/23.
//
#include <iostream>
...
int main()
{
    ...
    sources.push_back(GravitySource(500, 500, 7000, 10));
    sources.push_back(GravitySource(1000, 500, 7000, 10));
//    sources.push_back(GravitySource(250, 200, 7000));
    ...
    {
        particles.push_back(Particle(850, 200, 4, 0.2 + (0.1 / num_particles) * i));
//        particles.push_back(Particle(800, 0, 0, 0));
